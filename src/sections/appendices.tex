...
\section{Introduction to Appendices}\label{sec:intro}
Appendices contain supplementary material that would disrupt the flow of the main document.
The \texttt{appendix} package provides enhanced control over appendix formatting.
...
\section{Appendix Content Types}\label{sec:content}
...
\section{Cross-Referencing Appendices}\label{sec:references}
